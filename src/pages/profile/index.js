...
class Profile  extends Component {
  state = {
    ...
    company: "",
    phone: "",
    cover: "https://www.teahub.io/photos/full/254-2549402_background-facebook-cover-photo-size.jpg",
  ...
  componentDidMount() {
    ...
    axios.get(url, { headers: { "Authorization": `Bearer ${JWTToken}` } })
      .then((resp) => {
        console.log('Profilwe',resp)
        if (resp.success === false) { console.log("FALSE") }
        else {
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                  {this.state.name}<span class="font-weight-light"></span>
                </h3>
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>{this.state.email}
                </div>
                <div class="h5 font-weight-300">
                <i class="ni education_hat mr-2"></i>{this.state.phone}
                </div>
                <div class="h5 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>{this.state.company}
                </div>
                <hr class="my-4"/>
              </div>
            </div>
